...
//Server
const HTTP_SERVER       = 'http://x.app.loc/';
const HTTPS_SERVER      = 'https://x.app.loc/';

const HTTP_CATALOG      = 'http://x.app.loc/';
const HTTPS_CATALOG     ='https://x.app.loc/';



//DIR_FILES
const DIR_APPLICATION   = 'E:/openserver/domains/x.app.loc/app/';
